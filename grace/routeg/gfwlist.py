...
up="http://tomato-autovpn.googlecode.com/svn/trunk/grace/routeg/route"

upfile=open('route-grace','wa')
...
for l in range(len(uplines)):
	if uplines[l].find('all others') != -1:
		oldcnt_s = l
	if uplines[l].find('end making route') != -1:
		oldcnt_e = l
